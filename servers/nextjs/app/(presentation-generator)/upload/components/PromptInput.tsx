    ...
    <div className="space-y-2">
      <div className="relative">
        <Textarea
          ...
          className={`py-4 px-5 border-2 font-medium font-instrument_sans text-base min-h-[150px] max-h-[300px] border-[#a855f7] focus-visible:ring-offset-0  focus-visible:ring-[#a855f7] overflow-y-auto  custom_scrollbar  `}
        />
      </div>
      <p
