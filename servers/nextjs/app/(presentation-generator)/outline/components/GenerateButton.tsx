...
const GenerateButton: React.FC<GenerateButtonProps> = ({
    ...
    return (
        <Button
            ...
            className="bg-[#a855f7] w-full rounded-lg text-base sm:text-lg py-4 sm:py-6 font-instrument_sans font-semibold hover:bg-[#a855f7]/80 text-white disabled:opacity-50 disabled:cursor-not-allowed"
        >
            <svg
                className="mr-2"
                width="24"
